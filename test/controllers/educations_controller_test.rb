...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { end_date: @education.end_date, faculty: @education.faculty, name: @education.name, start_dat: @education.start_dat }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { end_date: @education.end_date, faculty: @education.faculty, name: @education.name, start_dat: @education.start_dat }
    assert_redirected_to education_path(assigns(:education))
  end
