...
class ResumesControllerTest < ActionController::TestCase
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post :create, resume: { courses: @resume.courses, email: @resume.email, hobby: @resume.hobby, name: @resume.name, phone: @resume.phone }
    end
  ...
  test "should update resume" do
    patch :update, id: @resume, resume: { courses: @resume.courses, email: @resume.email, hobby: @resume.hobby, name: @resume.name, phone: @resume.phone }
    assert_redirected_to resume_path(assigns(:resume))
  end
